...
import { columnsAdmission, listAdmission } from "./data/TableData";
...
export function Admission_Table() {
    ...
    const headerColumns = React.useMemo(() => {
        if (visibleColumns === "all") return columnsAdmission;

        return columnsAdmission.filter((column) =>
    ...
    const filteredItems = React.useMemo(() => {
        let filteredUsers = [...listAdmission];
            ...
            <div className="flex flex-col gap-4">
                ...
                <div className="flex justify-between items-center">
                    <span className="text-default-400 text-small">
                        Total {listAdmission.length} users
                    </span>
