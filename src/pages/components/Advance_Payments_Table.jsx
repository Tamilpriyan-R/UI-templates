...
import { ColumnAmount, ListAmount } from "./data/TableData";
...
export function Advance_Payment_Table() {
    ...
    const headerColumns = React.useMemo(() => {
        if (visibleColumns === "all") return ColumnAmount;

        return ColumnAmount.filter((column) =>
            Array.from(visibleColumns).includes(column.uid)
        );
    }, [visibleColumns]);

    const filteredItems = React.useMemo(() => {
        let filteredUsers = [...ListAmount];
...
export default Advance_Payment_Table;
