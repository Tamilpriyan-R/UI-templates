...
import { columnsBill, listBill } from "./data/TableData";
...
export function Bill_Table() {
    ...
    const headerColumns = React.useMemo(() => {
        if (visibleColumns === "all") return columnsBill;

        return columnsBill.filter((column) =>
            Array.from(visibleColumns).includes(column.uid)
        );
    }, [visibleColumns]);

    const filteredItems = React.useMemo(() => {
        let filteredUsers = [...listBill];
