...
import { ColumnVaccination, listVaccination } from "./data/TableData";
...
export function Discharge_Table() {
    ...
    const headerColumns = React.useMemo(() => {
        if (visibleColumns === "all") return ColumnVaccination;

        return ColumnVaccination.filter((column) =>
            Array.from(visibleColumns).includes(column.uid)
        );
    }, [visibleColumns]);

    const filteredItems = React.useMemo(() => {
        let filteredUsers = [...listVaccination];
                ...
                return (
                    <div className="relative flex justify-center items-center gap-2">
                        <Dropdown className="dark:bg-neutral-800">
                            ...
                            <DropdownItem onClick={() => generateAndDownloadFile('pdf', user)} className="text-blue-500 hover:underline cursor-pointer">Preview</DropdownItem>
            ...
            <div className="flex p-4 flex-col gap-4">
                ...
                <div className="flex justify-between items-center">
                    <span className="text-default-400 text-small">
                        Total {listVaccination.length} users
                    </span>
...
export default Discharge_Table;
