...
import { ColumnImageorder, listImageorder } from "./data/TableData";
...
export function Imageorder_Table() {
    ...
    const headerColumns = React.useMemo(() => {
        if (visibleColumns === "all") return ColumnImageorder;

        return ColumnImageorder.filter((column) =>
            Array.from(visibleColumns).includes(column.uid)
        );
    }, [visibleColumns]);

    const filteredItems = React.useMemo(() => {
        let filteredUsers = [...listImageorder];
            ...
            <div className="p-4 flex flex-col gap-4">
                ...
                <div className="flex justify-between items-center">
                    <span className="text-default-400 text-small">
                        Total {listImageorder.length} users
                    </span>
    ...
    return (
        <div id={Styles.userTableContainer}>
            <Table
                ...
                classNames={{
                    wrapper: "max-h-[320px] scrollbar-thin scrollbar-thumb-gray scrollbar-track-gray-200 p-4 pt-0",
                }}
...
export default Imageorder_Table;
