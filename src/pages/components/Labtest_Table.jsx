...
import { ColumnLab, listLab } from "./data/TableData";
...
export function Labtest_Table() {
    ...
    const headerColumns = React.useMemo(() => {
        if (visibleColumns === "all") return ColumnLab;

        return ColumnLab.filter((column) =>
            Array.from(visibleColumns).includes(column.uid)
        );
    }, [visibleColumns]);

    const filteredItems = React.useMemo(() => {
        let filteredUsers = [...listLab];
