...
const MedicinePurchaseEntryForm = ({ isOpen, onClose }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
            <div className="bg-white max-h-[550px]  overflow-y-auto dark:bg-gray-800 p-6 rounded shadow-lg">
                <h1 className="text-2xl font-semibold text-gray-800 dark:text-white mb-10" >Medicine Purchase Entry</h1>
                <form>
            ...
            <option value="fishOil">Fish Oil</option>
                    ...
                    <div className="mb-4 flex flex-wrap -mx-2">
                        <div className="w-full md:w-1/2 px-2 mb-4 md:mb-0">
                            ...
                            <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="purchasePrice" type="number" />
                        </div>
                        <div className="w-full md:w-1/2 px-2 mb-4 md:mb-0">
                    ...
                    <div className="mb-4 flex flex-wrap -mx-2">
                        <div className="w-full px-2 mb-4">
                            ...
                            <textarea className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="description" rows="4"></textarea>
                        </div>
                    </div>
...
export default MedicinePurchaseEntryForm;
