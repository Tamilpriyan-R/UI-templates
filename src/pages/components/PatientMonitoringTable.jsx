...
export function PatientMonitoringTable() {
  ...
  return (
    <div className="mx-auto my-6 flex max-w-screen-lg flex-col">
      ...
      >
        <TableHeader>
          ...
          <TableColumn>Pulse</TableColumn>
          <TableColumn>Temperature</TableColumn>
          <TableColumn>Respiratory</TableColumn>
          <TableColumn>Weight</TableColumn>
          <TableColumn>Fluid</TableColumn>
          <TableColumn>Medications</TableColumn>
          <TableColumn>Appointment</TableColumn>
