...
import { ColumnVac, listVac } from "./data/TableData";
...
export function Vaccination_Tab() {
    ...
    const headerColumns = React.useMemo(() => {
        if (visibleColumns === "all") return ColumnVac;

        return ColumnVac.filter((column) =>
            Array.from(visibleColumns).includes(column.uid)
        );
    }, [visibleColumns]);

    const filteredItems = React.useMemo(() => {
        let filteredUsers = [...listVac];
...
export default Vaccination_Tab;
