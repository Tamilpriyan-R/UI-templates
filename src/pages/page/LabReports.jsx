...
import LabReportTable from '../components/LabReportsTable';
import LabForm from '../components/Lab_Form';
...
const LabReports = () => {
    ...
    return (
        <div className="main-inner-wrapper leavemenu-wrapper" id={Styles.courseConatiner}>
            ...
            <div>
                <div className="pl-4 pb-2 pr-4 pt-4 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-500 rounded-xl ma h-auto max-h-100">
                    <div className="flex justify-between items-center gap-4">
                        <h1 className="text-2xl font-semibold text-gray-800 dark:text-white mb-4">Lab Reports</h1>
                        <button
            ...
            <LabForm isOpen={isOpen} onClose={handleClose} />
        </div>
    )
}
