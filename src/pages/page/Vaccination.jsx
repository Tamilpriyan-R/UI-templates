...
import Vaccination_Form from '../components/Vaccination_Form';
import Vaccination_Tab from '../components/Vac_Table';
...
const Vaccination = () => {
    ...
    return (
        <div className="main-inner-wrapper leavemenu-wrapper" id={Styles.courseConatiner}>
            ...
            <div>
                <div className="pl-4 pb-2 pr-4 pt-4 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-500 rounded-xl ma h-auto max-h-100">
                    <div className="flex justify-between items-center gap-4">
                        <h1 className="text-2xl font-semibold text-gray-800 dark:text-white mb-4">Recently Viewed Vaccination Report</h1>
                        <button
            ...
            <Vaccination_Form isOpen={isOpen} onClose={handleClose} />
        </div>
    );
};
